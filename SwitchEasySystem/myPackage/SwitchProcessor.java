 ...
 *
 */
public class SwitchProcessor implements RowProcessor
{	
	//Row columns
	private static final short COLUMN_INITIATOR = 1;
	private static final short COLUMN_ID = 2;
	private static final short COLUMN_PART = 3;
	private static final short COLUMN_PRIORITY = 4;
	private static final short COLUMN_SUPPLIER = 5;
	private static final short COLUMN_REASON = 6;
	private static final short COLUMN_COMMENT = 7;
	
	//private static final short COLUMN_ELSE = 7;
	/**
     * The singleton instance of this class.
     */
	private static SwitchProcessor thisProcessor;
	...
	public static RowProcessor getInstance()
	{
		...
		{
			thisProcessor = new SwitchProcessor();
		}
