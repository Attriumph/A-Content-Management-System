...
public class NewFeedbackProcessor implements RowProcessor
{	
	//Row columns
	private static final short COLUMN_ID = 0;
	private static final short COLUMN_PART = 1;
	private static final short COLUMN_REVISION = 2;
	private static final short COLUMN_REASON = 3;
	private static final short COLUMN_SOLUTION = 4;
	//private static final short COLUMN_ELSE = 4;
	
	private static NewFeedbackProcessor thisProcessor;
	
	
	private NewFeedbackProcessor()
	{
	...
	public static RowProcessor getInstance()
	{
		...
		{
			thisProcessor = new NewFeedbackProcessor();
		}
